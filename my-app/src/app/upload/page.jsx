  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="flex">
        ...
        <div className="w-[260px] border-dashed border-2 border-gray-300 rounded-lg p-8 flex flex-col items-center justify-center text-center">
          ...
          <button className="bg-red-500 text-white py-2 px-8 rounded-md w-full">
            Select file
          </button>
        </div>
        ...
        <div className="flex-1 ml-6">
          ...
          <div className="mb-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center">
                <input type="checkbox" id="comment" className="mr-2" />
          ...
          <div className="flex space-x-3 mt-6">
            <button className="px-6 py-2 border rounded-md font-medium">Discard</button>
            <button className="px-6 py-2 bg-red-500 text-white rounded-md font-medium">Post</button>
          </div>
        </div>
      </div>
    </div>
